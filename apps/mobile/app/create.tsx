...
import { DemoBadge, Heading, IconName } from "../src/rudi/ui";
    ...
    <SafeAreaView edges={["top", "bottom"]} style={styles.safe}>
      ...
      <View style={[styles.sheet, { backgroundColor: colors.ground, borderColor: colors.line }]}>
        ...
        <View style={styles.headingRow}>
          <Heading title="Mình làm gì tiếp?" subtitle="Một chạm để bắt đầu với Team Đà Lạt." size="h2" />
          <DemoBadge />
        </View>
...
const styles = StyleSheet.create({
  ...
  sheet: { borderTopLeftRadius: 30, borderTopRightRadius: 30, borderWidth: 1, paddingHorizontal: 18, paddingTop: 10, paddingBottom: 20, gap: 20 },
  handle: { alignSelf: "center", width: 42, height: 5, borderRadius: 99, opacity: 0.45 },
  headingRow: { gap: 10 },
  actions: { gap: 10 },
  action: { minHeight: 78, flexDirection: "row", alignItems: "center", gap: 13, padding: 13, borderRadius: 18, borderWidth: 1 },
