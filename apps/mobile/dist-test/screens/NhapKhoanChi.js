...
import { addParticipant, advancer, duplicateNames, labelFor, makeIdFactory, removeParticipant, } from "../participants.js";
...
export function NhapKhoanChi({ form, onForm, onNext, onSeeProposal, }) {
    const c = usePalette();
